...
<body >
    ...
    <a href="Register_makeups.aspx" class="main-menu">
        ...
        Register Makeup</a>     
                                    ...
                                    <li class="" >
    <a href="Makeup Exams.aspx" class="main-menu">
        <i style="font-style: normal;" class="metismenu-icon">👨🏻‍🏫</i>
        Choose Instructor
    </a>     
</li>
                            <li class="" >
                                    <i style="font-style: normal;" class="metismenu-icon">📄</i><asp:Button ID="GPButton" CssClass="abook" runat="server" Text="Graduation Plan" OnClick="All_Click"/>
                            </li>
                          <li class="">
       ...
       <ul class="mm-collapse mm-show">
        <li>
            <asp:Button ID="All" CssClass="abook" runat="server" Text="All Courses" OnClick="All_Click"/>
        </li>
                 ...
                 <li>
                    <asp:Button ID="Slotb" onclick="Optional" CssClass="abook" runat="server" Text="Courses and Slots"/>
                 </li>
...
.vertical-nav-menu ul>li>a, .vertical-nav-menu ul>li>.abook{
  color: #6c757d;
  height: 2rem;
  line-height: 2rem;
  padding: 0 1.5rem 0
...
.vertical-nav-menu ul>li>a:hover,.vertical-nav-menu ul>li>.abook:hover {
  color: #3f6ad8
}
